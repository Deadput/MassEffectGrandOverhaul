class X2Item_GuardianShield extends X2Item config(GuardianShield);
...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	Weapons.AddItem(GuardianShield_CV());
	Weapons.AddItem(GuardianShield_MG());
	Weapons.AddItem(GuardianShield_BM());

	return Weapons;
}

static function X2WeaponTemplate GuardianShield_CV()
{
	local X2WeaponTemplate Template;

	`CREATE_X2TEMPLATE(class'X2WeaponTemplate', Template, 'GuardianShield_CV');
	Template.ItemCat = 'weapon';
	Template.WeaponCat = 'shield';
	Template.WeaponTech = 'conventional';
	Template.strImage = "img:///GuardianShield_Assets.Inv_AllianceShield"; 
	...
	Template.iRange = 0;
	Template.iRadius = 1;
	Template.GameArchetype = "GuardianShield_Assets.ARC_AllianceShield"; 
	Template.Tier = -1;
...
static function X2DataTemplate GuardianShield_MG()
{
	local X2WeaponTemplate Template;

	`CREATE_X2TEMPLATE(class'X2WeaponTemplate', Template, 'GuardianShield_MG');
	...
	Template.BaseItem = 'GuardianShield_CV'; // Which item this will be upgraded from
...
static function X2DataTemplate GuardianShield_BM()
{
	local X2WeaponTemplate Template;

	`CREATE_X2TEMPLATE(class'X2WeaponTemplate', Template, 'GuardianShield_BM');
	Template.WeaponPanelImage = "_Sword";                       // used by the UI. Probably determines iconview of the weapon.
	...
	Template.BaseItem = 'GuardianShield_MG'; // Which item this will be upgraded from
